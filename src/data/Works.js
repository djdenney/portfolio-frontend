const Works = [
    {
        ...
        text: ["This was the summative full stack capstone project for Thinkful.com's 'Software Engineering Flex' curriculum.", "The goal of this project was to create a front end web application that could usefully create, read, update, and delete reservation and table information stored in a database using an API"],
        date: "May 2021",
        technology: [
            "Brand New Identity",
        ...
        links: [
            ...
            { Deployment: "https://periodic-tables-frontend-eosin.vercel.app/dashboard" },
        ],
